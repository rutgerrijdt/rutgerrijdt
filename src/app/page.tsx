...
const SECTIONS: { id: Section; label: string; icon: string; sub: string }[] = [
  { id: 'hypotheek', label: 'Hypotheek',            icon: '🏠', sub: 'GHF & NHG berekeningen' },
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex items-center justify-between py-3 border-b border-gray-100">
            <div>
              <h1 className="text-lg font-bold text-gray-900">Financieel Rekentool</h1>
              <p className="text-xs text-gray-500">Hypotheek · Salaris · ORV · Vermogen — 2026</p>
            </div>
            {section === 'hypotheek' && view === 'list' && (
              <button
                onClick={openNew}
          ...
          <nav className="flex overflow-x-auto">
            {SECTIONS.map((s) => (
              <button
                ...
                onClick={() => {
                  setSection(s.id);
                  if (s.id !== 'hypotheek') setView('list');
                }}
      ...
      {/* ---- Hypotheek section: form view ---- */}
      {section === 'hypotheek' && view === 'form' && current && (() => {
            ...
            <div className="bg-white border-b border-gray-100 sticky top-[104px] z-10">
              <div className="max-w-6xl mx-auto px-4 flex items-center">
                <button
                  ...
                  className="text-sm text-blue-600 hover:underline font-medium py-3 pr-4 border-r border-gray-100 mr-2"
                >
                  ← Overzicht
                </button>
